...
A ideia desse programa foi de abrir uma figura mal iluminada, a qual foi obtida através de modificações fietas no programa gimp para deixar uma parte da figura um pouco mais escura e a outra mais clara e então efetuar a aplicação da filtragem homomórfica.
